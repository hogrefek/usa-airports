...
// The content of the popup window is the value of `feature.properties.company`
    ...
    // Assigning Style Class to each cell phone company and
    ...
    pointToLayer: function (feature, latlng) {
      ...
      attribution: 'Cell Tower Data &copy; Map Cruzin | Oregon counties &copy; Oregon Explorer | Base Map &copy; CartoDB | Made By Kyle R. Hogrefe'
});
// Add the cellTowers to the map.
cellTowers.addTo(mymap);

// 6. Set function for color ramp for counties
